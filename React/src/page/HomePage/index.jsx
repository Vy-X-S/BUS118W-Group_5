...
import { getProductList, setProductListReducer } from "../../redux/reducers/ProductList/actionTypes";
...
const HomePage = () => {
  ...
  //       const sets = distributeProducts(response.data, 3, 8); // For example, 2 sets with 5 products each
  //       setDivision1(sets[0]);
  //       setDivision2(sets[1]);
  //       setDivision3(sets[2]);
  //   } catch (error) {
  ...
  //     .then((response) => {
  //       dispatch(setProductListReducer(response.data));
  //       const sets = distributeProducts(response.data, 3, 8); // For example, 2 sets with 5 products each
  //       setDivision1(sets[0]);
  //       setDivision2(sets[1]);
  //       setDivision3(sets[2]);
